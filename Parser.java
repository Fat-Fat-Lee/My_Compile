...
//        Parser.blockStack.remove(Parser.blockStack.size()-1);
    ...
    public List<List<String>> constInitValParser(Lexer tmpLexer,List<String> resLexerList,List<String> resllList){
        System.out.println("in constInitVal");

        //二维String赋值数组,后面要把大括号剥开，直接整个送去处理
        ...
        else
        {
            ...
            tmpString.add(resString);
            resStringList.add(tmpString);
    ...
    public List<List<String>> initValParser(Lexer tmpLexer,List<String> resLexerList,List<String> resllList){
